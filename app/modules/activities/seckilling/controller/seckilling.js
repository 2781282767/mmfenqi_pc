    ...
    module.exports = function (app) {
        ...
        app.register.controller('SeckillingCtrl', ['$scope', '$http','Bridge','$location',
            function ($scope, $http,Bridge,$location) {
                ...
                $scope.query(1, $scope.common().start,$scope.common().end);
                ...
                $scope.tomorrow = function () {
                    ...
                    $scope.query(1, $scope.common().tomorrow_start, $scope.common().tomorrow_end)
                ...
                $scope.getSome=function () {
                    ...
                    if(!!$scope.todayed){
                        ...
                        $scope.query($scope.today_index, $scope.common().start,$scope.common().end)
                    }else if(!!$scope.tomorrowed){
                        $scope.tomorrow_index=$scope.tomorrow_index+1;
                        $scope.query($scope.tomorrow_index, $scope.common().tomorrow_start, $scope.common().tomorrow_end)
                    }
                };
