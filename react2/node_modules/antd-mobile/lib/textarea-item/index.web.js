...
var TextareaItem = function (_React$Component) {
    ...
    TextareaItem.prototype.render = function render() {
        ...
        return _react2["default"].createElement("div", __assign({}, (0, _getDataAttr2["default"])(this.props), { className: wrapCls, style: style }), title ? _react2["default"].createElement("div", { className: labelCls }, title) : null, _react2["default"].createElement("div", { className: prefixCls + '-control' }, _react2["default"].createElement("textarea", __assign({}, valueProps, { ref: "textarea", name: name, rows: rows, placeholder: placeholder, maxLength: count, onChange: this.onChange, onBlur: this.onBlur, onFocus: this.onFocus, readOnly: !editable, disabled: disabled }))), clear && editable && value && value.length > 0 ? _react2["default"].createElement("div", { className: prefixCls + '-clear', onClick: this.clearInput, onTouchStart: this.clearInput }) : null, error ? _react2["default"].createElement("div", { className: prefixCls + '-error-extra', onClick: this.onErrorClick }) : null, count > 0 && rows > 1 ? _react2["default"].createElement("span", { className: prefixCls + '-count' }, _react2["default"].createElement("span", null, value && value.length), "/", count) : null);
    };
