...
var Grid = function (_React$Component) {
    ...
    Grid.prototype.render = function render() {
        ...
        var renderItem = this.props.renderItem || function (dataItem) {
            return _react2["default"].createElement("div", { className: prefixCls + '-item-contain column-num-' + columnNum, style: { height: defaultHeight + 'px' } }, _react2["default"].createElement("img", { className: prefixCls + '-icon', src: dataItem.icon }), _react2["default"].createElement("div", { className: prefixCls + '-text' }, dataItem.text));
        };
        var lineElArray = [];
        var pageElArray = [];
        if (data) {
            for (var i = 0; i < lineCount; i++) {
                ...
                var _loop = function _loop(j) {
                    ...
                    if (dataIndex < dataLength) {
                        lineContent.push(_react2["default"].createElement(_flex2["default"].Item, { className: itemCls, onClick: function onClick() {
                                if (_this2.props.onClick) {
                                    _this2.props.onClick(data && data[dataIndex], dataIndex);
                                }
                            }, key: 'griditem-' + dataIndex }, renderItem(data[dataIndex], dataIndex)));
                    } else {
                ...
                lineElArray.push(_react2["default"].createElement(_flex2["default"], { justify: "center", align: "stretch", key: 'gridline-' + i }, lineContent));
            }
        }
        ...
        if (isCarousel && pageCount > 1) {
            for (var pageIndex = 0; pageIndex < pageCount; pageIndex++) {
                ...
                pageElArray.push(_react2["default"].createElement("div", { className: prefixCls + '-carousel-page', key: 'pageitem-' + pageIndex }, pageLines));
            }
        }
        return _react2["default"].createElement("div", { className: wrapCls }, isCarousel && pageCount > 1 ? _react2["default"].createElement(_index2["default"], null, pageElArray) : lineElArray);
    };
