...
var InputItem = function (_React$Component) {
    ...
    InputItem.prototype.render = function render() {
        ...
        return _react2["default"].createElement(_reactNative.View, { style: [_index2["default"].container, containerStyle, style] }, children ? _react2["default"].createElement(_reactNative.Text, { style: [_index2["default"].text, textStyle] }, children) : null, _react2["default"].createElement(_reactNative.TextInput, { style: [_index2["default"].input, inputStyle], value: value, keyboardType: type === 'number' || type === 'bankCard' ? 'numeric' : 'default', onChange: function onChange(event) {
                return _this2.onChange(event.nativeEvent.text);
            }, onFocus: onFocus, onBlur: onBlur, placeholder: placeholder, autoCorrect: false, secureTextEntry: type === 'password', clearButtonMode: clear ? 'while-editing' : 'never', editable: editable }), extra ? _react2["default"].createElement(_reactNative.TouchableWithoutFeedback, { onPress: onExtraPress }, _react2["default"].createElement(_reactNative.View, null, _react2["default"].createElement(_reactNative.Text, { style: [_index2["default"].extra, extraStyle] }, extra))) : null, error && _react2["default"].createElement(_reactNative.TouchableWithoutFeedback, { onPress: onErrorPress }, _react2["default"].createElement(_reactNative.View, { style: [_index2["default"].errorIcon] }, _react2["default"].createElement(_reactNative.Image, { source: require('../style/images/error.png'), style: { width: _default2["default"].icon_size_xs, height: _default2["default"].icon_size_xs } }))));
    };
