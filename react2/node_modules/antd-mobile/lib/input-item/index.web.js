...
var InputItem = function (_React$Component) {
    ...
    InputItem.prototype.render = function render() {
        ...
        return _react2["default"].createElement("div", __assign({}, (0, _getDataAttr2["default"])(this.props), { className: wrapCls, style: style }), children ? _react2["default"].createElement("div", { className: labelCls }, children) : null, _react2["default"].createElement("div", { className: prefixCls + '-control' }, _react2["default"].createElement("input", __assign({ ref: "input" }, valueProps, { type: inputType, maxLength: maxLength, name: name, placeholder: placeholder, onChange: this.onInputChange, onBlur: this.onInputBlur, onFocus: this.onInputFocus, readOnly: !editable, disabled: disabled }, patternProps))), clear && editable && !disabled && value && value.length > 0 ? _react2["default"].createElement("div", { className: prefixCls + '-clear', onClick: this.clearInput }) : null, error ? _react2["default"].createElement("div", { className: prefixCls + '-error-extra', onClick: this.onErrorClick }) : null, extra !== '' ? _react2["default"].createElement("div", { className: prefixCls + '-extra', onClick: this.onExtraClick }, extra) : null);
    };
