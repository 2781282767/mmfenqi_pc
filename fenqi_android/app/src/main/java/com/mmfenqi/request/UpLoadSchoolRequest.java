 ...
 * 上传学籍信息认证接口
 */
public class UpLoadSchoolRequest extends MmfqAsynnClientJson {
	private UpLoadSchoolListener mListener;
	public interface UpLoadSchoolListener {
		/** 成功回调方法 */
	...
	public void goUpload(String url,RequestParams params,UpLoadSchoolListener mListener){
