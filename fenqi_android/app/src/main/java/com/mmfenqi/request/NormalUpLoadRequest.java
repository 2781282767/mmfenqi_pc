...
public class NormalUpLoadRequest extends MmfqAsynnClientJson {
	private NormalUpLoadListener mListener;
	public interface NormalUpLoadListener {
		/** 成功回调方法 */
	...
	public void upLoad(String url,RequestParams params,NormalUpLoadListener mListener){
