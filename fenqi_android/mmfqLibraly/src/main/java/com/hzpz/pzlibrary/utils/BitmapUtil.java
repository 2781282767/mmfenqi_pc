...
public class BitmapUtil {
	 ...
	 * @return
	 */
	public synchronized byte[] getByteArr(Bitmap bitmap) {
		if (bitmap == null) {
			return null;
		}
	 ...
	 * 
	 * @param type
	 *            具体参见：{@link BitmapFillet.ALL} , {@link BitmapFillet.TOP} , {@link BitmapFillet.LEFT} , {@link BitmapFillet.RIGHT} , {@link BitmapFillet.BOTTOM}
	 * @param bitmap
	 *            需要被切圆角的图片
	 * @param roundPx
	 *            要切的像素大小
	...
	public static Bitmap blurBitmap(Bitmap bitmap, Context ctx, int hei) {
		if (TelephoneUtil.getApiLevel() < 17) {
			...
			/*
			 * Bitmap outBitmap = Bitmap.createBitmap(bitmap.getWidth(), hei, Config.ARGB_8888); return bitmap;
			 */
		}
