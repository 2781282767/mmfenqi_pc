...
class R_Banner extends React.Component {
    ...
    render() {
        ...
        var categories = this.state.category.map(function (item, index) {
            return (
                <li key={index} className="jingxuan">
                    <div style={{width: 35,height: 35,marginLeft: 25,marginRight: 15,float: 'left',display:'flex'}}>
        ...
        var banner = this.state.banner.map(function (item, index) {
            ...
            return (<li style={{display: 'block', background: item.backgroundColor}} key={index}
        ...
        return (
            <div className="banner">
                ...
                <div className="btnList-all">
                    <div className="pull_down left" style={{marginTop: -1}}>
