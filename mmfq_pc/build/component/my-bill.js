                                    ...
                                    React.createElement(
                                        ...
                                        React.createElement(
                                            ...
                                            React.createElement(
                                                ...
                                                React.createElement(
                                                    'li',
                                                    { style: { display: json.repayment_status == 1 ? 'inline-block' : 'none' } },
                                                    '还款状态: ',
                                                    React.createElement(
                                                        'b',
                                                        null,
                                                ...
                                                React.createElement(
                                                    'li',
                                                    { style: { display: json.repayment_status == 2 ? 'inline-block' : 'none' } },
                                                    '还款状态: ',
                                                    React.createElement(
                                                        'b',
                                                        null,
                                                ...
                                                React.createElement(
                                                    'li',
                                                    { style: { display: json.repayment_status == 0 ? 'inline-block' : 'none' } },
                                                    '还款状态: ',
                                                    React.createElement(
                                                        'span',
                                                        { style: { color: '#ff682c', fontSize: '12px' } },
                                                        _this3.getType(json.repayment_status)
                                                    ),
                                                    ' '
                                                ),
                                                React.createElement(
                                                    'li',
                                                    { style: { display: json.repayment_status == 3 ? 'inline-block' : 'none' } },
                                                    '还款状态: ',
                                                    React.createElement(
                                                        'span',
                                                        { style: { color: '#ff65da', fontSize: '12px' } },
                                                        _this3.getType(json.repayment_status)
                                                    ),
                                                    ' '
                                                )
